...
av_dic = {
    ...
    "hws.exe": "护卫神",
    "hwsd.exe": "护卫神",
    "HwsHostPanel.exe": "护卫神主机大师",
    "HwsHostMaster.exe": "护卫神主机大师",
    "HipsTray.exe": "火绒",
    "HipsDaemon.exe": "火绒",
    "SPHINX.exe": "SPHINX防火墙",
    "emet_agent.exe": "EMET",
    ...
    "KSafeSvc.exe": "金山毒霸",
    "KWatch.exe": "金山毒霸",
    "gov_defence_service.exe": "云锁升级版",
    "gov_defence_daemon.exe": "云锁升级版",
...
def get_missing_av():
    for process, name in add_dic.items():
        if process not in av_dic:
